...
public class PlayerHitscanProjectileController : MonoBehaviour {
	...
	void Update () {
        ...
        if (distance >= totalDistance)
        {
            ...
            if (target!=null && target.CompareTag("Enemy"))
            {
                ...
                if (e == null)
                {
                    e = target.GetComponentInParent<Enemy>();
                }

                e.Hit(1, targetPos, direction);
            ...
            PoolManager.Pools["Bullet"].Despawn(transform, 0.2f);
